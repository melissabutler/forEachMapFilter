...
function showFirstAndLast(arr){
    ...
    //     let stringify = arr[index].toString();
    //     const firstLetter = stringify[0];
    //     const lastLetter = stringify[value.length -1];
    //     let newStr = (firstLetter + lastLetter).toString();
    //     newArr.push(newStr);
    // })
    return newArr;
}
...
function addKeyAndValue(arr,key,value){
    ...
    //     const addToObj = {...obj, title: newValue};

    //     newArray.push(addToObj);
    // }
    // return newArray;
    // };
...
function vowelCount(str){
    ...
    splitArray.forEach(function(letter){
        ...
        //if a vowel is present in the index of lowercaseLetter
        if(vowels.indexOf(lowercaseLetter) !== -1){
            console.log('vowel exists')
            //check if letter is already assigned, 
            if(obj[lowercaseLetter]){
                //if yes, add one
                console.log('vowel is already found, add 1')
                obj[lowercaseLetter]++;
            } else {
                //if no, change object number to be one
                obj[lowercaseLetter] = 1;
                console.log('vowel has not been counted')
            }
        }
    });
    return obj;
